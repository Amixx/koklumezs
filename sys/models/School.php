...
class School extends \yii\db\ActiveRecord
{
    ...
    public static function getDifficultiesColor($schoolID)
    {
        $school = self::find()->where(['id' => $schoolID])->one();
        if($school->difficulties_color)
            return $school->difficulties_color;
        return 'gray';
    }
}
