...
class CommentResponsesController extends Controller
{
    ...
    {
        // $query = CommentResponses::getAllForUser();
        // $dataProvider = new ActiveDataProvider([
        //     'query' => $query,
        //     'sort' => ['defaultOrder' => ['created' => SORT_DESC]],
        // ]);
        // $clonedQuery = clone $query;
        // $responses = $clonedQuery->all();
        // foreach ($responses as $response) {
        //     // $model = $this->findModel($response);
        //     // $response['seen_by_author'] = 1;
        //     // $response->save();
        // }
        // $data = Userlectureevaluations::getCommentsResponsesForUser();
