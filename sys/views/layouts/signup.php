...
$schoolId = Yii::$app->request->get()["s"];
$lang = Yii::$app->request->get()["l"];

$school = School::findOne($schoolId);

$wrapperBackground = $school->registration_background_image != null
    ? "url($school->registration_background_image)"
