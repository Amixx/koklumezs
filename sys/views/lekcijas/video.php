...
?>
    <div class="row">
        ...
        ?>
            <div class="col-md-12">
                <p><?= $file['title'] ?></p>
                <video id="my-player<?= $id ?>" class="video-js vjs-layout-x-large vjs-big-play-centered" controls preload="auto" poster="<?= $file['thumb'] ? $file['thumb'] : $baseUrl . '/files/cover.jpg' ?>" data-setup='{}'>
